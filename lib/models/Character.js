...
export default class Character {
  ...
  static async put(id, character) {
    ...
    SET name = $1, 
        ...
        is_human = $10
    WHERE id = $11
    RETURNING *`, [character.name, character.japaneseName, character.image, character.abilities, character.nationality, character.catchphrase, character.family, character.chapter, character.living, character.isHuman])
